...
public class Adapter extends BaseAdapter {
    ...
    public Adapter(Context ctx, ArrayList<JSONObject> objects) {
        this.ctx = ctx;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            t.setText(f.getString("nameEn"));
            t.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Global.positionWord = position;
                    Intent intent = new Intent(parent.getContext(), SearchByWordDetail.class);
